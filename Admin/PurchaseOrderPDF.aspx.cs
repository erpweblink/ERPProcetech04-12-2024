...
public partial class Admin_PurchaseOrderPDF : System.Web.UI.Page
{
    ...
    private void Pdf()
    {
        ...
        png.ScaleToFit(90, 100);

        //For Image Position
        png.SetAbsolutePosition(20, 755);
        ...
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 120, 778, 0);
        cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 9);
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PL LC 03, FLAT NO B-506, POLITE HERMITAGE, SECTOR NO 18, CHIKHALI PRADHIKARN CHINCHWAD, Pune. 411019 Maharashtra", 110, 761, 0);
        ...
        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GSTIN : 27AAHCP6642H1Z6", 48, 720, 0);
        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PAN NO: AAHCP6642H1", 180, 720, 0);
        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "EMAIL : info@procetech.in", 300, 720, 0);
        cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
        cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CONTACT : 9373654308", 455, 720, 0);
        cbbb.EndText();
