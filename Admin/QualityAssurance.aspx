<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="QualityAssurance.aspx.cs" Inherits="Admin_QualityAssurance" %>
                            ...
                            <div class="row" style="padding: 10px;">
                                ...
                                <div class="page-header-breadcrumb" runat="server" visible="false">
                                    <div style="float: right; margin: 3px; margin-bottom: 5px;">
                                        <span id="btnfinalassemblyoldlist" runat="server"><a href="FinalAssembly_OldDB.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp;FINAL ASSEMBLY OLD DATA</a>&nbsp;&nbsp;
                                        </span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row" runat="server">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlstages" CssClass="form-control">
                                                ...
                                                <asp:ListItem Text="Laser Programing" Value="tblLaserPrograming">TPP Programing</asp:ListItem>
