...
public partial class Admin_TaxInvoicePDF : System.Web.UI.Page
{
    ...
    protected void Pdf()
    {
       ...
       // string imageURL = Server.MapPath("~") + "/img/Procetech.jpg";  
        ...
        //For Image Position
        png.SetAbsolutePosition(50, 745);
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 155, 788, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GAT NO 199, BEHIND JYOTIBA TEPMLE JYOTIBANAGAR TALAWADE PUNE,", 175, 770, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Pimpri-Chinchwad, Maharashtra 411062", 240, 755, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "E-mail : sales@procetechautomation.com", 235, 740, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            ...
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GSTIN :27AAHCP6642H1Z6" + "", 48, 715, 0);
            cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PAN NO: AAHCP6642H" + "", 170, 715, 0);
            cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "MAHARASHTRA STATE GST CODE : 27" + "", 280, 715, 0);
            cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CIN : U74900PN2014PTC15044", 455, 715, 0);
            cbbb.EndText();
            ...
            if (transactionmode== "BY HAND")
            {

                table.AddCell(new Phrase("Transporter Persson", FontFactory.GetFont("Arial", 9, Font.NORMAL)));
            ...
            if (billingCustomer == ShippingCustomer)
            {
                //table.AddCell(new Phrase(" Details of Buyer/Billed to: \n Web link Services Pvt. ltd. \n 2nd and 3rd Floor , Meera Building, Durga Mata Colony, behind Shivar Garden Restaurant, Pimple Saudagar, Pune, Maharashtra 411027 ", FontFactory.GetFont("Arial", 9, Font.NORMAL)));
            ...
            if (Dt.Rows[0]["IGSTPer"].ToString() == "0")
            {
                ...
                if (Dt.Rows.Count == 1)
                {
                    table.AddCell(new Phrase("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", FontFactory.GetFont("Arial", 9, Font.BOLD)));   //change for new
                }
           ...
           // Bind stamp Image
            //string imageStamp = Server.MapPath("~") + "/img/pngprocetech.png";
        ...
        png1.ScaleToFit(95, 100);

        //For Image Position
        png1.SetAbsolutePosition(45, 750);
        //var document = new Document();
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 155, 788, 0);
            cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GAT NO 199, BEHIND JYOTIBA TEPMLE JYOTIBANAGAR TALAWADE PUNE,", 175, 770, 0);
            cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Pimpri-Chinchwad, Maharashtra 411062", 240, 755, 0);
            cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb1.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "E-mail : sales@procetechautomation.com", 235, 740, 0);
            cb1.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            ...
            table.AddCell(new Phrase("Place of Supply :", FontFactory.GetFont("Arial", 9, Font.NORMAL)));
            table.AddCell(new Phrase(" 2nd and 3rd Floor , Meera Building, Durga Mata Colony, behindShivar Garden Restaurant, Pimple Saudagar, Pune, Maharashtra411027", FontFactory.GetFont("Arial", 9, Font.NORMAL)));
