...
public partial class Admin_ReceiptPDF : System.Web.UI.Page
{
    ...
    protected void Pdf(string id)
    {
        ...
        //For Image Position
        png.SetAbsolutePosition(30, 765);
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 155, 810, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Gat No. 199, behind Jyotiba Temple, Jyotiba Nagar, Talwade, Pune, ", 190, 795, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Pimpri-Chinchwad, Maharashtra 411062", 245, 781, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "E-mail : sales@procetechautomation.com", 240, 768, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            ...
            image1.ScaleToFit(900, 70);
            PdfPCell imageCell = new PdfPCell(image1);
            imageCell.PaddingLeft = 190f;
            imageCell.PaddingTop = 30f;
