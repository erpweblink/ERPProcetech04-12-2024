...
public partial class Admin_Addenquiry : System.Web.UI.Page
{
    ...
    protected void GetCompanyData(string id)
    {
        ...
        query1 = "SELECT [id],[ccode],[cname],[filepath1],[filepath2],[filepath3],[filepath4],[filepath5],[remark],[SalesPerson],[RefNo],[Enquiryrefmode] FROM [EnquiryData] where id='" + id + "' ";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            ddluser.SelectedItem.Text = dt.Rows[0]["SalesPerson"].ToString();
            txtrefno.Text = dt.Rows[0]["RefNo"].ToString();
             txtEnquiryRefrence.Text = dt.Rows[0]["Enquiryrefmode"].ToString();
    ...
    protected void GetCompanyDataByName(string cname)
    {
        ...
        {
            lblmsg.Visible = true;
            lblmsg.Text = "customer Not found Please add customer first !!";
    ...
    protected void GenerateComCode()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            ComCode = "EN2425000" + (maxid + 1).ToString();
        }
        else
        {
            ComCode = "EN24250001";
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        if (btnadd.Text == "Add Enquiry")
        {
            ...
            if (!string.IsNullOrEmpty(ComCode))
            {
                ...
                cmd.Parameters.AddWithValue("@SalesPerson", ddluser.SelectedItem.Text);
                cmd.Parameters.AddWithValue("@refno", txtrefno.Text);
                cmd.Parameters.AddWithValue("@Enquiryrefmode", txtEnquiryRefrence.Text);
     ...
     public void GetUser()
    {
        try
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("[SP_EnquiryData]", connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@Action", "Getuser"));
                    ...
                    if (Dt.Rows.Count > 0)
                    {
                        ...
                        ddluser.DataBind();
                        ddluser.Items.Insert(0, "--Select Sales Person --");
