...
public partial class Admin_PurchaseOrder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                txtPONo.Text = GenerateNewNumber();
            }
        }
    }
    ...
    protected void GetPurchaseOrderData(string id)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            ddltaxation.Text = dt.Rows[0]["TaxType"].ToString();
            GetGStDEtails();
            ...
            txtDeliverydate.Text = DelivertDate.ToString("yyyy-MM-dd");
        ...
        if (btnadd.Text == "Add PO")
        {
            ...
            if (!string.IsNullOrEmpty(PONo))
            {
                ...
                if (dgvParticularsDetails.Rows.Count > 0)
                {
                    ...
                    cmd.Parameters.AddWithValue("@TaxType", ddltaxation.SelectedItem.Text.Trim());
                    int a = 0;
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("[SP_PaymnetTerms]", connection))
                {
                    ...
                    if (Dt.Rows.Count > 0)
                    {
                        ...
                        ddlPaymentTerm.Items.Add(new System.Web.UI.WebControls.ListItem("Select", ""));
    ...
    public string GenerateNewNumber()
    {
        ...
        string poNumber = "222425000" + maxid.ToString();
