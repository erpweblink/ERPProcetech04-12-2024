<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinalinspectionReportlist.aspx.cs" Inherits="Admin_FinalinspectionReportlist" MasterPageFile="~/Admin/AdminMasterPage.master" %>
            ...
            <div class="container py-3">
                <div class="card">
                    <div class="card-header bg-primary text-uppercase text-white">
                        <div class="row">
                            <div class="col-md-4">
                                <h5>Final Inspection Report List</h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-3">
                                            <asp:TextBox ID="txtCustomerName" runat="server" CssClass="form-control" placeholder="Customer Name" Width="100%" AutoPostBack="true" ></asp:TextBox>
                                                ...
                                                <asp:GridView ID="GvInvoiceList" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Project" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblInvoicedate" runat="server" Text='<%# Eval("Project") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Project Jo" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCustomerPO" runat="server" Text='<%# Eval("Jo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Po Number" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblGrandTotal" runat="server" Text='<%# Eval("PoNo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
