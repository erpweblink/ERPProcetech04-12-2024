...
public partial class PDFShow : System.Web.UI.Page
{
    ...
    private void Pdf(string Name)
    {
        ...
        if(Name== "Laser Programming")
        {
            Name = "TPP Programming";
        }

        if (Name == "Laser Cutting")
        {
            Name = "TPP Cutting";
        }
        ...
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 85, 815, 0);
