...
public partial class Admin_TaxInvoicePDF : System.Web.UI.Page
{
    ...
    protected void Pdf()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Procetech Automation Pvt Ltd.", 50, 780, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 18);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "27AAHCP6642H1Z6", 50, 740, 0);


            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PL LC 03, FLAT NO B-506, POLITE HERMITAGE, SECTOR NO 18,", 50, 725, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CHIKHALI PRADHIKARN CHINCHWAD, Pune. 411019", 50, 715, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            ...
            //if (billingCustomer == ShippingCustomer)
            //{
            //    //table.AddCell(new Phrase(" Supplier : \n\n " + "GSTIN : 27AAHCP6642H1Z6" + "\n " + "Procetech Automation Pvt Ltd." + " \n " + "PL LC 03, FLAT NO B-506, POLITE HERMITAGE, SECTOR NO 18," + "\n" + " CHIKHALI PRADHIKARN CHINCHWAD, Pune." + "  \n " + " Maharashtra, 411019", FontFactory.GetFont("Arial", 9, Font.NORMAL)));
    ...
    protected void Pdf_CRDBNote()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PL LC 03, FLAT NO B-506, POLITE HERMITAGE, SECTOR NO 18,", 50, 725, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CHIKHALI PRADHIKARN CHINCHWAD, Pune.", 50, 715, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, " Maharashtra, 411019", 50, 705, 0);
            cb.EndText();
