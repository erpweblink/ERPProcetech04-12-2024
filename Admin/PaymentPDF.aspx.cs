...
public partial class Admin_PaymentPDF : System.Web.UI.Page
{
    ...
    protected void Pdf(string id)
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Pimpri-Chinchwad, Pune. 411019 Maharashtra", 230, 781, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "E-mail : sales@procetechautomation.com", 225, 768, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 11);
            ...
            image1.ScaleToFit(800, 80);
            PdfPCell imageCell = new PdfPCell(image1);
            imageCell.PaddingLeft = 160f;
