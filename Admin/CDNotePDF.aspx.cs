...
public partial class Admin_TaxInvoicePDF : System.Web.UI.Page
{
    ...
    protected void Pdf(string flg)
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 155, 820, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GAT NO 199, BEHIND JYOTIBA TEPMLE JYOTIBANAGAR TALAWADE PUNE, ", 155, 808, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "Pimpri-Chinchwad, Maharashtra 411062", 210, 798, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "E-mail : sales@procetechautomation.com", 205, 785, 0);
            cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            ...
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "GSTIN :AAHCP6642H1" + "", 48, 765, 0);
            cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PAN NO: AAHCP6642H1" + "", 170, 765, 0);
            cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "MAHARASHTRA STATE GST CODE : 27" + "", 280, 765, 0);
            cbbb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 10);
            cbbb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "CIN : U74900PN2014PTC15044", 445, 765, 0);
            cbbb.EndText();
            ...
            image1.ScaleToFit(600, 100);
            PdfPCell imageCell = new PdfPCell(image1);
            imageCell.PaddingLeft = 19f;
            imageCell.PaddingTop = 6f;
            /////////////////
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            ...
            if (document.PageNumber > 1)
            {
                ...
                if (File.Exists(imageURL))
                {
                    ...
                    PdfContentByte cb = writer.DirectContent;
                    cb.SetFontAndSize(BaseFont.CreateFont(@"C:\Windows\Fonts\Calibrib.ttf", "Identity-H", BaseFont.EMBEDDED), 20);
                    cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "PROCETECH AUTOMATION PVT. LTD.", 95, 810, 0);
                }
                else
                {
