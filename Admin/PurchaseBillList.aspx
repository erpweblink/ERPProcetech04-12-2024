                                            ...
                                            <div style="overflow: scroll;" class="dt-responsive table-responsive" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                                <asp:GridView ID="GvPurchaseBill" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Supplier Code" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="linkscode" runat="server" CssClass="linkbtn" CommandName="Suppliername" Text='<%# Eval("SCode") %>'   CommandArgument='<%# Eval("SCode") %>' ToolTip="View Details"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
