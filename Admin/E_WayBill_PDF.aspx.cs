...
public partial class Admin_TaxInvoicePDF : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                if (F_Qrdtl != "")
                {
                    ...
                    GenerateQR(EwbNo, "27AAHCP6642H1Z6", EwbDt);
            ...
            if (Request.QueryString["Idd"] != null)
            {
                ...
                if (F_Qrdtl != "")
                {
                    ...
                    GenerateQR_CrDbNote(EwbNo, "27AAHCP6642H1Z6", EwbDt);
    ...
    protected void EwayPdf()
    {
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            table.AddCell(new Phrase("27AAHCP6642H1Z6    Procetech Automation Pvt Ltd.", FontFactory.GetFont("Arial", 10, Font.NORMAL)));
            ...
            table2.AddCell(new Phrase("27AAHCP6642H1Z6   \nProcetech Automation Pvt Ltd.", FontFactory.GetFont("Arial", 10, Font.NORMAL)));
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                table.AddCell(new Phrase(transDocDate, FontFactory.GetFont("Arial", 9)));
                table.AddCell(new Phrase("27AAHCP6642H1Z6", FontFactory.GetFont("Arial", 9)));
                table.AddCell(new Phrase(" -", FontFactory.GetFont("Arial", 9)));
                table.AddCell(new Phrase(" -", FontFactory.GetFont("Arial", 9)));
