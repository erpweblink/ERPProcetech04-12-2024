...
public partial class Admin_TaxInvoiceList : System.Web.UI.Page
{
    ...
    protected void GVBinddata()
    {
        try
        {
            ...
            SqlDataAdapter sad = new SqlDataAdapter("select TOP 10 * from tblTaxInvoiceHdr where isdeleted='0' order by CreatedOn DESC", con);
            sad.Fill(dt);
        ...
        try
        {
            ...
            else
            {
                ...
                if (FrightValuee == "0")
                {
                    ...
                    // Final Grandtotal
                    SqlCommand cmdTotInvVal = new SqlCommand("select SUM(cast(GrandTotal as float)) FROM [tblTaxInvoiceDtls] where headerId='" + ID + "'", con);
        ...
        try
        {
            ...
            if (DT_AuthToken.Rows.Count > 0)
            {
                ...
                else
                {
                   ...
                   // AuthToken = DT_AuthToken.Rows[0]["AuthToken"].ToString();  // original code
                }
            }
            else
            {
