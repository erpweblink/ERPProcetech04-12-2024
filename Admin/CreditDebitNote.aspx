                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="txtPaymentDueDate" CssClass="form-control" runat="server" Width="100%" AutoComplete="off" OnTextChanged="txtPaymentDueDate_TextChanged" AutoPostBack="true" TextMode="Date"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="txtBillDate" CssClass="form-control" runat="server" Width="100%" AutoComplete="off"  TextMode="Date"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" border="1" style="width: 100%; border: 1px solid #0c7d38;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtTCGSTPer" Width="50px" runat="server"  AutoPostBack="true" OnTextChanged="txtTCGSTPer_TextChanged"></asp:TextBox>
                                                                <asp:TextBox ID="txtTCGSTamt" Width="100px" runat="server" Text="0" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTSGSTPer" Width="50px" runat="server"  AutoPostBack="true" OnTextChanged="txtTSGSTPer_TextChanged"></asp:TextBox>
                                                                <asp:TextBox ID="txtTSGSTamt" Width="100px" runat="server" Text="0" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTIGSTPer" Width="50px" runat="server"  AutoPostBack="true" OnTextChanged="txtTIGSTPer_TextChanged"></asp:TextBox>
