                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table" border="1" style="width: 100%; border: 1px solid #0c7d38;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <asp:Button ID="btnaddperticular" runat="server" Text="Add" OnClick="btnaddperticular_Click" />
                                                                    </center>
                                                                </td>
                                                                <td>
                                                                    <center>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <asp:TextBox ID="txtCGST" CssClass="srtxt" placeholder="%" onkeyup="sum()" onfocus="select()" runat="server" Enabled="false"></asp:TextBox>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <%-- <asp:AutoCompleteExtender ID="AutoCompleteExtender4" runat="server" CompletionListCssClass="completionList"
                                                        ...
                                                        TargetControlID="ddltransportation">
                                                    </asp:AutoCompleteExtender>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" Display="Dynamic" ErrorMessage="Please Enter Transportation"
                                                        ControlToValidate="ddltransportation" ValidationGroup="form1" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                                </div>
