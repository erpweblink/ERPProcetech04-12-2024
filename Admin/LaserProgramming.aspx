                            ...
                            <div class="row" style="padding: 20px; display: none;" id="divReturn">
                                <div class="col-md-6">
                                    <div class="row" runat="server">
                                        ...
                                        <div class="col-md-3 spancls">Stages:</div>
                                        <div class="col-md-3">
                                            <asp:DropDownList runat="server" ID="ddlstages" CssClass="form-control">
                                                <asp:ListItem Text="Select" Value="0">Select</asp:ListItem>
                                                <asp:ListItem Text="Drawing Creation" Value="tblDrawing">Drawing Creation</asp:ListItem>
                                                <%--                                                <asp:ListItem Text="Laser Programing" Value="tblLaserPrograming">Laser Programing</asp:ListItem>--%>
                                                <%--<asp:ListItem Text="Laser Cutting" Value="tblLaserCutting"> Laser Cutting</asp:ListItem>
                                            ...
                                            <asp:GridView ID="dgvLaserprogram" runat="server" CssClass="table table-striped table-bordered nowrap"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Customer Code" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                        <ItemTemplate>
                                                            <%-- <asp:TextBox runat="server" ID="lblCustName" ReadOnly="true" TextMode="MultiLine" Rows="4" Width="130" CssClass="form-control" Text='<%# Eval("CustomerCode") %>'></asp:TextBox>--%>
                                                            <asp:Label ID="lblSubOANumber" CssClass="lblsuboa" runat="server" Text='<%# Eval("SubOA") %>' Visible="true"></asp:Label>
                                                            <asp:Label ID="lblCustomerCode" runat="server" Text='<%# Eval("CustomerCode").ToString().Replace(" ", "<br /><br />") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
