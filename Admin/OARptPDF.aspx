            ...
            <table class="auto-style16" style="width: 80%; margin: 0 auto; margin-top: 20px; margin-bottom: 20px; font-weight: bold;">
                <tr>
                    <td class="auto-style17" style="border: 1px solid; text-align: center; padding: 10px;">
                        ...
                        <img src="../img/ProcetechPDFLOGO.jpg" /></td>
                    <td style="border: 1px solid;">
                        <h1 style="text-align: center; font-family: fantasy;">PROCETECH AUTOMATION PVT. LTD</h1>
                        <p style="text-align: center">GAT NO 199, BEHIND JYOTIBA TEPMLE JYOTIBANAGAR TALAWADE PUNE, PIMPRI-CHINCHWAD, MAHARASHTRA 411062 </p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center; border: 1px solid;">GSTIN : AAHCP6642H1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PAN NO : AAHCP6642H1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; EMAIL : <a href=" sales@procetechautomation.com">sales@procetechautomation.com</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CIN : U74900PN2014PTC15044</td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        <div class="row" style="margin: 0 auto; width: 100%; margin-top: 20px;">
                            <asp:GridView ID="dgvOARpt" runat="server" CssClass="table table-striped table-bordered nowrap Grid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Qty" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" Visible="true">
                                       ...
                                       <asp:TemplateField HeaderText="UOM" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" Visible="true">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Price" ItemStyle-Width="100" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblBasicLabel" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Right" runat="server">Basic Amount</asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Amount" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Right">
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblAmountbasic" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Right" runat="server"></asp:Label>
                                            <%--<asp:Label ID="lblAmount" ItemStyle-Width="100" runat="server"></asp:Label>--%>
                                        </FooterTemplate>
                                    </asp:TemplateField>



                                    <asp:TemplateField HeaderText="SGST" ItemStyle-Width="100" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSGST" runat="server" Text='<%# Eval("SGST") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="CGST" ItemStyle-Width="100" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCGST" runat="server" Text='<%# Eval("CGST") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="IGST" ItemStyle-Width="100" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemTemplate>
                            ...
                            <div class="text-right" style="color: red">
                                <asp:Label ID="lblGrandtotalval" runat="server" Text="Label"></asp:Label>
                            </div>

                            <asp:Label ID="lblAmountbasic" ItemStyle-Width="100" runat="server"></asp:Label>
                        </div>
                    ...
                    <td colspan="2">
                        <table class="nav-justified" style="margin-top: 20px;">
                            <tr>
                                ...
                                <td>CGST(<asp:Label runat="server" ID="lblCGSTPer" CssClass="lbl"></asp:Label>
                                    %)&nbsp;
                                    Amount:
                                    <asp:Label runat="server" ID="lblCGSTAmt" CssClass="lbl"></asp:Label>

                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style202"></td>
                                <td>SGST(<asp:Label runat="server" ID="lblSGSTPer" CssClass="lbl"></asp:Label>
                                    %)&nbsp; 
                                    Amount:
                                    <asp:Label runat="server" ID="lblSGSTAmt" CssClass="lbl"></asp:Label>

                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style202"></td>
                                <td>IGST(<asp:Label runat="server" ID="lblIGSTPer" CssClass="lbl"></asp:Label>
                                    %)&nbsp; 
                                    Amount:
                                    <asp:Label runat="server" ID="lblIGSTAmt" CssClass="lbl"></asp:Label>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div class="row" style="text-align: end; margin-top: 20px; margin-right: 10px;">
                                        ...
                                        <div class="col-md-4"></div>
                                        <div class="col-md-4">
                                            <asp:Label runat="server">For Procetech Automation Pvt. Ltd.</asp:Label>
                                        </div>
                                    </div>
                                    <div class="row" style="text-align: end; margin-right: 40px;">
                                        <div class="col-md-4"></div>
                                        <div class="col-md-4"></div>
