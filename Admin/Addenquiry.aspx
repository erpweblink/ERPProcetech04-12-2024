                ...
                <div class="col-md-5">
                    <div class="page-header-breadcrumb">
                        <div style="float: right; margin: 3px; margin-bottom: 5px;">
                            ...
                            <span><a href="AddCompany.aspx" style="font-size: 16px; border: 1px dashed gray; padding: 4px;">&nbsp; Add Customer </a>&nbsp;&nbsp;
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <br />
                                        <div class="row">
                                            <div class="col-md-2 spancls">Enquiry Against: </div>
                                            <div class="col-md-4">
                                        ...
                                        <br />
                                        <div class="row">
                                            <div class="col-md-2 spancls">Ref. No: </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <%--<div class="col-md-2"></div>--%>
                                            <div class="col-md-2 spancls">Enquiry Ref. Mode : </div>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtEnquiryRefrence" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Display="Dynamic" ErrorMessage="Please Enter Address"
                                                    ControlToValidate="txtshippingaddress" ValidationGroup="form1" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <center>
                                                    <asp:Button ID="btnadd" runat="server" ValidationGroup="form1" CssClass="btn btn-primary" Width="100%" Text="Add Enquiry" OnClick="btnadd_Click" /></center>
                                            </div>
                                            <div class="col-md-2">
                                                <center>
