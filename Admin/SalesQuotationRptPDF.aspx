        ...
        <div id="DivSaleQuatation">
            ...
            <table class="auto-style16" style="width: 80%; margin: 0 auto; margin-top: 20px; margin-bottom: 20px; font-weight: bold;">
                <tr>
                    ...
                    <img src="../img/ProcetechPDFLOGO.jpg" />
                ...
                <tr>
                    <td colspan="2" style="text-align: center; border: 1px solid;">GSTIN :  27AAHCP6642H126 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PAN NO : AAHCP6642H1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; EMAIL : <a href="mailto:sales@procetechautomation.com">sales@procetechautomation.com</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CIN : U74900PN2014PTC150</td>
                </tr>
                <tr>
                            ...
                            <asp:GridView ID="dgvSalesQuatationRpt" runat="server" CssClass="table table-striped table-bordered nowrap Grid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Qty" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" Visible="true">
                                        ...
                                        <asp:TemplateField HeaderText="Unit" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblunit" runat="server" Text='<%# Eval("UOM") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Rate" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                             <asp:Label ID="txtRate" runat="server" Text='<%# Eval("Currency").ToString()+" "+ Eval("rate") %>'></asp:Label>
                                               <asp:Label ID="lblrate1" runat="server" Text='<%# Eval("rate") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div class="row" style="text-align: end; margin-top: 20px; margin-right: 10px;">
                                        ...
                                        <div class="col-md-4"></div>
                                        <div class="col-md-4">
                                            <asp:Label runat="server">For Proetech Automation Pvt. Ltd.</asp:Label>
                                        </div>
                                    </div>
