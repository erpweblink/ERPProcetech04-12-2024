...
public partial class Admin_CreditDebitList : System.Web.UI.Page
{
    ...
    private void Gvbind()
    {
        ...
        query = @"select * from tblCreditDebitNoteHdr AS A
LEFT JOIN tblSupplierMaster AS SM ON SM.SupplierName=A.SupplierName where NoteFor='Purchase' order by A.Id desc";
